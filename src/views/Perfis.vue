<template>
  <div class="wrapper container">
    <div class="content row">
      <div class="card col" @click="irParaPlanejamento()">
        <div class="icon">
...
export default {
  ...
  methods: {
    async buscarPerfis() {
      ...
      await Axios.get(`http://127.0.0.1:8000/api/v1/companies/${id}/company-profile`, {
    ...
    irParaPlanejamento() {
      let id = this.$route.params.empresa;
      this.$router.push({ name: "planejamento", params: { empresa: id } });
    },

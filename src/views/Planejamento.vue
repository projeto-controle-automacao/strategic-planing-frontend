  ...
  <div>
    ...
    <div class="page">
      <label class="field a-field a-field_a1">
        <input class="field__input a-field__input" v-model="form.planejamento" placeholder="Explique motivo do planejamento" required />
        <span class="a-field__label-wrap">
          <span class="a-field__label">Planejamento</span>
        </span>
      </label>
      <label class="field a-field a-field_a1">
        <input class="field__input a-field__input" v-model="form.duracao" placeholder="Em meses" number required />
        <span class="a-field__label-wrap">
